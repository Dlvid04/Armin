...
public class Paper : MonoBehaviour
{
    ...
    void Update()
    {
        if (LA.LookingAt() != null && LA.LookingAt().name == "RiddlePaper" && Input.GetKeyDown(InputManager.Instance.Interact) && ReadPaper == false) {
        ...
        } else if (ReadPaper == true && Input.GetKeyDown(InputManager.Instance.Interact)) {
